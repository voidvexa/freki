...
SIGNAL_SYSTEM_PROMPT = (
    ...
    "Weigh the evidence objectively. You do not need perfect alignment across every timeframe and indicator, "
    "but the overall weight of technical and macro evidence must present a compelling risk/reward setup. "
    "For example, if macro data is deteriorating and technicals are rotating bearish, a SHORT signal may be "
    "appropriate even if one indicator lags. Strive for a balance: do not trade every setup, but do not sit "
    "out of valid opportunities waiting for perfection. Signal LONG or SHORT when a clear edge exists; "
